...
public class KreditMotor {
    ...
    static void isiData() {
        do {
            ...
            System.out.println("1. 6 bulan  (Bunga 8% per tahun)");
            System.out.println("2. 12 bulan (Bunga 10% per tahun)");
            System.out.println("3. 24 bulan (Bunga 12% per tahun)");
            System.out.println("4. 36 bulan (Bunga 15% per tahun)");
    ...
    static void cetakStruk(DataPembeli pembeli) {
    System.out.println("\n===========================================");
